...
<div class="slideshow">
<img src="<?php print $base_path . $directory; ?>/images/slideshows/sea.jpg" width="1100" height="100" alt="slideshow 1"/>
</div>
</div>
</div>
<?php endif; ?>
...
<div style="clear:both"></div>
<div id="notice"><p><B>Copyright © Cancer Center Informatics</B>-2011 Regents of the University of Michigan></p></div>
</div>